<template>
  <div class="root-container">
    <a-form layout="inline">
      <h3>评估</h3>
      <a-row v-for="(k, index) in form.getFieldValue('assessments')" :key="k">
        <a-form-item
          label="评估"
      ...
      <h3>处方</h3>
      <a-row v-for="(k, index) in form.getFieldValue('prescriptions')" :key="k">
        <a-form-item
          label="药名"
      ...
      <h3>运动</h3>
      <a-row v-for="(k, index) in form.getFieldValue('sports')" :key="k">
        <a-form-item
          label="运动"
          class="width-20-percent"
          :label-col="formItemLayout.labelCol"
      ...
      <h3>饮食建议</h3>
      <a-row v-for="(k, index) in form.getFieldValue('diets')" :key="k">
        <a-form-item
          label="饮食建议"
      ...
      <h3>其他建议</h3>
      <a-row v-for="(k, index) in form.getFieldValue('others')" :key="k">
        <a-form-item
          label="其他建议"
          class="width-80-percent"
          :label-col="formItemLayout.labelCol"
