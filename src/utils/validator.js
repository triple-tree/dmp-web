...
Checker = (function () {
        ...
        maxDay =
          '01,03,05,07,08,10,12'.indexOf(month) >= 0
            ...
            : '04,06,09,11'.indexOf(month) >= 0
              ? 30
              : ((isLeapYear = (year % 4 === 0 && year % 100 !== 0) || year % 400 === 0), isLeapYear ? 29 : 28)
  ...
  Checker.prototype.idNo = function (id) {
  ...
  Checker.prototype.twid = function (id) {
  ...
  Checker.prototype.hkid = function (id) {
  ...
  Checker.prototype.krid = function (id) {
    var isChecksumValid, isDateValid, isFormatValid, isLengthValid
    isLengthValid = function (id) {
      return id.length === 13
    }
